# Technical management field playbooks

These playbooks connect program intent to controlled product realization. They provide clean-room questions and evidence patterns, not local compliance procedures.

| Situation | Start here |
|---|---|
| Requirement or acceptance basis is uncertain | [Requirements and verification](01-requirements-and-verification.md) |
| Product definition, revision, or effectivity is uncertain | [Configuration management](02-configuration-management.md) |
| A boundary between organizations, products, systems, or processes is failing | [Interface management](03-interface-management.md) |
