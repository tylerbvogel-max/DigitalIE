...
**Do:** write the objective, units, variables, constraints represented and omitted, evidence for every coefficient, and applicability assumptions; run the deterministic function; retain all evaluated-alternative counts and tie rules; challenge the answer with sensitivity and feasibility review.
